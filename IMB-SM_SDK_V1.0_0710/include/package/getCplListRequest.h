...
ModuleName :
FileName   £º getCplListRequest.h
...
********************************************/
#ifndef GET_CPLLIST_REQUEST_H
#define GET_CPLLIST_REQUEST_H
...
UInt32 FormatGetCplListRequest(	TEXT	*UserID,
								UInt8	*NewRequestBuf,
								UInt32	*BufLen );
UInt32 ParseGetCplListRequest(	UInt8	*RequestBuf,
								UInt32	BufLen,
								UInt32	*RequestId,
								TEXT	*UserID );
...
public:
    ...
    UInt32 FormatGetCplListRequest(
				/* in */ TEXT	*UserID,
				/* out*/ UInt8  *NewRequestBuf,
				/* out*/ UInt32 *BufLen );

    UInt32 ParseGetCplListRequest(
				/* in */ UInt8	*RequestBuf,
				/* in */ UInt32	BufLen,
